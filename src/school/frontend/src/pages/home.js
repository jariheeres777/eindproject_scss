...
const homepage = () => {
    ...
    //header main page
    //section about
    // is uniek dus alleen hier
    //DEZE IS UNIEK DUS ALLEEN HIER
    return (
        <div>
            <Nav/>
            <Header className='header mainpage' name="exotics" line="Find your next exotic">
            </Header>
            <Sectionabout titletext1="why uss?" textone="the exotics forum is a modern platform for reptile enthusiasts from all over the world to share
            ...
            <>
                ...
                <section className="section-about section-two">
                    ...
                    <div className="gate-to-forum u-center-text color-orange">
                        <p>the forum is the place were you can share your thoughts and experiences with like-minded
                            keepers
                            and
                            hobbyists
                        </p>
