...
const AlligatorAndCrocodilepage = () => {
    return (
        <div>
            ...
            <Sectionabout titletext1="some info about ALLIGATORS AND CROCODILES"
                          headertext="Difference Between Alligators and Crocodiles?" textone="Snout shape: Alligators have wider, U-shaped snouts, while crocodile front ends are more pointed and V-shaped.
